...
function twentyten_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Top Bar Left', 'twentyten' ),
		'id' => 'bar-topleft-widget-area',
	...
	register_sidebar( array(
		'name' => __( 'Top Bar Right', 'twentyten' ),
		'id' => 'bar-topright-widget-area',
	...
	register_sidebar( array(
		'name' => __( 'Mobile Menu Bar Left', 'twentyten' ),
		'id' => 'mobilemenu-topleft-widget-area',
		'description' => __( 'Widget area for the top bar', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name' => __( 'Mobile Menu Bar Right', 'twentyten' ),
		'id' => 'mobilemenu-topright-widget-area',
		'description' => __( 'Widget area for top bar', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name' => __( 'Under Footer Widget Area', 'twentyten' ),
		'id' => 'under-footer-widget-area',
		'description' => __( 'The under footer widget area', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
function convoyQuote($params = array(), $content = "") {
	...
	return '</div><div class="blog-quote"><img src="'.get_template_directory_uri().'/images/quote-top.png" /><div class="inner-quote"><div class="from">'.$from.'</div><div class="quote">'.$content.'</div></div><img src="'.get_template_directory_uri().'/images/quote-bottom.png" /></div><div class="post-content">';
}
