	...
	if (have_posts()) {
		while ( have_posts() ) {
            ...
            <div class="post-content">
                ...
                <?php the_content(); ?>
                <div class="share">
                    <h2>Share: <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" class="share-link"><i class="fab fa-facebook-f"></i></a> <a href="https://twitter.com/intent/tweet?text=<?php the_permalink();?> text" class="social-share"><i class="fab fa-twitter"></i></a> <i class="fab fa-linkedin-in"></i> <i class="fas fa-envelope"></i></h2>
                </div>
            </div>
            <?php
        }
