	...
	if (have_posts()) {
		while ( have_posts() ) {
            ...
            <div class="post-content">
                ...
                <?php the_content(); ?>
                <div class="share">
                    <h2>Share: <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" class="share-link"><i class="fab fa-facebook-f"></i></a> <a href="https://twitter.com/intent/tweet?text=<?php echo get_bloginfo("name"). " " . get_the_title(). " " . get_the_permalink(); ?>" class="social-share"><i class="fab fa-twitter"></i></a> <a href="https://www.linkedin.com/shareArticle?mini=true&url=http%3A//mywwebsite.com&title=title" class="social-share"><i class="fab fa-linkedin-in"></i></a> <a href="mailto:?subject=<?php the_title(); ?>&body=<?php the_permalink(); ?>"><i class="fas fa-envelope"></i></a></h2>
                </div>
            </div>
            <?php
        }
